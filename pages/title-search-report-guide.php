...
return array (
  ...
  'h1_title' => 'Title Search Report: Legal Due Diligence & Title Opinion Guide',
  'schema_type' => 'TechArticle',
  'faq_data' => '[{"question":"Why is a Title Search Report mandatory for bank home loans?","answer":"Banks require a Title Search Report from an empaneled advocate to ensure the property offered as mortgage security holds clear, marketable title free from prior bank liens, court attachments, or ownership disputes."}]',
  'content' => '<div class="manual-page-container" style="line-height: 1.8; color: var(--text-main);">
    <p style="font-size: 1.08rem; margin-bottom: 25px;">
        A <strong>Title Search Report (TSR)</strong> or <strong>Legal Title Investigation Report</strong> is an exhaustive legal opinion issued by an experienced property advocate or real estate legal practitioner certifying the marketability, legal ownership continuity, and encumbrance status of an immovable property. Mandatory for nationalized bank home loans, commercial property acquisitions, and residential layout developments, a thorough Title Search Report investigates chronological title deeds, revenue records, SRO Encumbrance Certificates, court litigation records, and land acquisition notices for a minimum continuous timeline of 13 to 30 years.
    </p>
    ...
    <div class="quick-summary-box" style="background: rgba(241, 245, 249, 0.7); padding: 20px; border-radius: 8px; margin-bottom: 30px;">
        <h3 style="margin-top: 0; color: var(--primary);">Key Facts: Title Search Report (TSR)</h3>
        <ul>
            <li><strong>Legal Purpose:</strong> Verifies whether the seller holds a clear, marketable, and unencumbered legal title free from liens, bank mortgages, and legal disputes.</li>
            <li><strong>Mandatory Search Timeline:</strong> Minimum 13 years for basic transactions; 30 years for nationalized bank mortgage loan financing.</li>
            <li><strong>Key Documents Investigated:</strong> Primary Sale Deeds, Parent Title Deeds, SRO Encumbrance Certificates (Form 15), Revenue Records (Patta, RTC, 7/12, Adangal), Building Sanction Plans, and Public Notice Receipts.</li>
            <li><strong>Issuing Authority:</strong> Empaneled bank advocate or independent real estate advocate registered with the State Bar Council.</li>
        </ul>
    </div>

    <h2 id="section-1" style="color: var(--primary); font-size: 1.5rem; margin-top: 30px;">1. Essential Components of a Water-Tight Title Search Report</h2>
    <p>A professional Title Search Report structured according to Bar Council and banking guidelines contains the following statutory sections:</p>
    <ol class="step-list">
        <li><strong>Description of Property & Schedule:</strong> Complete identification including survey numbers, plot area, ward classifications, municipal assessment numbers, and cardinal physical boundaries.</li>
        <li><strong>Chronological Title Flow (Recitals):</strong> Detailed trace of title transfers spanning 30 years detailing every Sale Deed, Gift Deed, Partition Deed, Release Deed, or Inheritance probate.</li>
        <li><strong>Inspection of SRO Encumbrance Certificates (Form 15):</strong> Verification of registered transactions, volume/page numbers, and verification of mortgage discharge receipts.</li>
        <li><strong>Revenue & Tax Compliance Audit:</strong> Inspection of revenue land registers (Patta/Chitta, RTC Bhoomi, 7/12, Adangal 1B) and municipal tax assessment receipts.</li>
        <li><strong>Public Notice Publication:</strong> Verification of newspaper public notices published in leading regional and English daily newspapers inviting title objections within 14 days.</li>
        <li><strong>Final Legal Opinion & Certification:</strong> Clear, unambiguous statement declaring whether the property title is <em>"Clear, Marketable, and Free from All Encumbrances."</em></li>
    </ol>
    ...
    <div class="faq-container">
        <div class="faq-item">
            <h4 class="faq-question">Q1: Why is a Title Search Report mandatory for bank home loans?</h4>
            <p class="faq-answer">Banks require a Title Search Report from an empaneled advocate to ensure the property offered as mortgage security holds clear, marketable title free from prior bank liens, court attachments, or ownership disputes.</p>
        </div>
        <div class="faq-item">
            <h4 class="faq-question">Q2: What is the difference between a Preliminary Title Report and a Final Title Search Report?</h4>
            <p class="faq-answer">A Preliminary Title Report identifies missing documents or title defects requiring seller clarification. A Final Title Search Report is issued after all title requisitions, revenue entries, and public notices are satisfied.</p>
        </div>
    </div>
</div>
