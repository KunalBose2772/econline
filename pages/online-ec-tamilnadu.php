<?php
return array (
  'slug' => 'online-ec-tamilnadu',
  'keyword' => 'online ec tamilnadu, encumbrance certificate online tamilnadu, tnreginet ec online, villangam சான்றிதழ், tn ec online',
  'title' => 'Online EC Tamil Nadu: TNREGINET Villangam Search & View (2026)',
  'meta_desc' => 'Search & download Tamil Nadu Encumbrance Certificate (Villangam சான்றிதழ்) online via TNREGINET. Free EC view, Patta Chitta, Guideline Value & SRO fees.',
  'h1_title' => 'Online EC Tamil Nadu: TNREGINET Villangam Certificate Guide',
  'schema_type' => 'TechArticle',
  'faq_data' => '[{"question":"How can I view a Villangam Certificate (EC) online in Tamil Nadu?","answer":"Visit the official TNREGINET portal (tnreginet.gov.in), navigate to \'E-Services\' -> \'Encumbrance Certificate\' -> \'View EC\'. Enter your Zone, District, Sub-Registrar Office (SRO), Village, Survey Number, or Document Number to view the certificate online."},{"question":"What is the official website for Tamil Nadu property registration services?","answer":"The official portal administered by the Commercial Taxes and Registration Department of Tamil Nadu is tnreginet.gov.in."},{"question":"What is the difference between a Villangam Certificate (EC) and Patta Chitta in Tamil Nadu?","answer":"Villangam Certificate (EC) is issued by TNREGINET (Registration Department) tracking registered sale deeds, mortgages, and encumbrances. Patta Chitta is issued by the Revenue Department (eservices.tn.gov.in) verifying land ownership, survey boundary extents, and revenue tax logs."},{"question":"Is viewing an EC on TNREGINET free for citizens?","answer":"Yes. Searching and viewing information copies of Encumbrance Certificates on TNREGINET is completely free. Fees apply only when ordering digitally signed official certified PDF copies."},{"question":"How do I check Guideline Value in Tamil Nadu on TNREGINET?","answer":"Navigate to \'Guideline Value\' on tnreginet.gov.in, select your Street Name or Survey Number, select the Zone and Sub-Registrar Office, and click Search to view current per-sq-ft or per-acre guideline rates."}]',
  'content' => '
<div class="manual-page-container" style="line-height: 1.7; color: var(--text-main);">
    
    <!-- Hero Summary -->
    <div class="hero-summary-card" style="background: linear-gradient(135deg, rgba(5, 150, 105, 0.05) 0%, rgba(4, 120, 87, 0.1) 100%); border: 1px solid var(--border); border-radius: 12px; padding: 24px; margin-bottom: 30px;">
        <p style="font-size: 1.05rem; margin-bottom: 15px;">In Tamil Nadu, an <strong>Encumbrance Certificate (Villangam சான்றிதழ்)</strong> is an essential legal document that verifies property title ownership and registered encumbrance liabilities. The Government of Tamil Nadu enables citizens to search, view, and download certified EC copies online through the upgraded <strong>TNREGINET Portal</strong> (`tnreginet.gov.in`), while land revenue records are checked via the <strong>AnyAMI Patta Chitta Portal</strong>.</p>
        <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-top: 15px;">
            <a href="/tnreginet-ec-view/" class="btn-primary" style="padding: 10px 20px; font-weight: 600; text-decoration: none; border-radius: 6px; background: #059669; border-color: #059669;" title="TNREGINET EC View Guide">TNREGINET EC View Guide</a>
            <a href="/patta-chitta-online-tamil-nadu/" class="btn-secondary" style="padding: 10px 20px; font-weight: 600; text-decoration: none; border-radius: 6px; background: var(--surface); border: 1px solid var(--border);" title="Patta Chitta Guide">Patta Chitta Guide</a>
        </div>
    </div>

    <!-- Quick Snapshot Table -->
    <h2 style="color: var(--primary); font-size: 1.5rem; margin-top: 30px; margin-bottom: 15px;">Tamil Nadu Property Registration Overview</h2>
        ...
        <table class="responsive-data-table" style="width: 100%; border-collapse: collapse; border: 1px solid var(--border); background: var(--surface);">
            <thead>
                <tr style="background: #059669; color: white;">
                    ...
                    <th style="padding: 12px 15px; text-align: left; border: 1px solid var(--border);">Tamil Nadu Portal Details</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td style="padding: 12px 15px; border: 1px solid var(--border); font-weight: 600;">Official Registration Portal</td>
                    <td style="padding: 12px 15px; border: 1px solid var(--border);"><a href="https://tnreginet.gov.in" target="_blank" rel="noopener" title="Official TNREGINET Portal">TNREGINET (`tnreginet.gov.in`)</a></td>
                </tr>
                <tr style="background: rgba(241, 245, 249, 0.5);">
                    <td style="padding: 12px 15px; border: 1px solid var(--border); font-weight: 600;">Revenue Land Records Portal</td>
                    <td style="padding: 12px 15px; border: 1px solid var(--border);">AnyAMI Patta Chitta Portal (`eservices.tn.gov.in`)</td>
                </tr>
                <tr>
                    <td style="padding: 12px 15px; border: 1px solid var(--border); font-weight: 600;">Administering Department</td>
                    <td style="padding: 12px 15px; border: 1px solid var(--border);">Commercial Taxes and Registration Department, Government of Tamil Nadu</td>
                </tr>
                <tr style="background: rgba(241, 245, 249, 0.5);">
                    <td style="padding: 12px 15px; border: 1px solid var(--border); font-weight: 600;">Digitized Timeline Coverage</td>
                    <td style="padding: 12px 15px; border: 1px solid var(--border);">1975 to Present Date (Over 50 Years of Online Records)</td>
                </tr>
            </tbody>
        </table>
    </div>

    <!-- Step-by-Step TNREGINET EC Search -->
    <h2 style="color: var(--primary); font-size: 1.5rem; margin-top: 35px; margin-bottom: 15px;">How to View Villangam Certificate on TNREGINET</h2>
    <div class="steps-container" style="display: flex; flex-direction: column; gap: 15px; margin: 25px 0;">
        
        <div class="step-card" style="padding: 18px; border-left: 4px solid #059669; background: rgba(248, 250, 252, 0.8); border-radius: 0 8px 8px 0; border: 1px solid var(--border); border-left-width: 4px;">
            <strong style="color: var(--primary); font-size: 1.1rem;">Step 1: Open TNREGINET Portal</strong>
            <p style="margin: 8px 0 0 0;">Visit <a href="https://tnreginet.gov.in" target="_blank" rel="noopener" title="TNREGINET Portal">tnreginet.gov.in</a> and switch language preference to English or Tamil as desired.</p>
        </div>

        <div class="step-card" style="padding: 18px; border-left: 4px solid #059669; background: rgba(248, 250, 252, 0.8); border-radius: 0 8px 8px 0; border: 1px solid var(--border); border-left-width: 4px;">
            <strong style="color: var(--primary); font-size: 1.1rem;">Step 2: Navigate to Encumbrance Certificate Search</strong>
            <p style="margin: 8px 0 0 0;">Click on <strong>"E-Services"</strong> in the main navigation bar, hover over <strong>"Encumbrance Certificate"</strong>, and select <strong>"View EC"</strong>.</p>
        </div>

        <div class="step-card" style="padding: 18px; border-left: 4px solid #059669; background: rgba(248, 250, 252, 0.8); border-radius: 0 8px 8px 0; border: 1px solid var(--border); border-left-width: 4px;">
            <strong style="color: var(--primary); font-size: 1.1rem;">Step 3: Enter Search Location & Parameters</strong>
            <p style="margin: 8px 0 0 0;">Select your Registration <strong>Zone</strong> (e.g. Chennai, Coimbatore, Madurai, Trichy), <strong>District</strong>, <strong>Sub-Registrar Office (SRO)</strong>, and <strong>Village</strong>. Enter your Survey Number, Subdivision, or Document Number/Year.</p>
        </div>

        <div class="step-card" style="padding: 18px; border-left: 4px solid #059669; background: rgba(248, 250, 252, 0.8); border-radius: 0 8px 8px 0; border: 1px solid var(--border); border-left-width: 4px;">
            <strong style="color: var(--primary); font-size: 1.1rem;">Step 4: Generate & Download Statement PDF</strong>
            <p style="margin: 8px 0 0 0;">Enter the Captcha and click <em>"Search"</em>. The system will display all registered Index II entries. Click <em>"Download PDF"</em> to save a local copy of your Villangam certificate statement.</p>
        </div>
...
<div class="db-legacy-content" style="margin-top: 30px;"><!-- Custom Rebuilt Interactive Styles -->
<style>
    /* Toolkit Wrapper */
    .toolkit-container {
        margin: 2rem 0;
...
<div class="card" style="border-top: 4px solid var(--accent); margin-bottom: 1.5rem; background: linear-gradient(180deg, #f8fafc 0%, #ffffff 100%);">
    ...
    <div class="portal-quick-grid">
        <a href="https://tnreginet.gov.in/portal/webEServices/viewEC" target="_blank" rel="nofollow noopener" class="portal-btn" title="Visit the official 🔍
            View Free EC website (External Link)">
            <span class="portal-btn-icon">🔍</span>
            <span>View Free EC</span>
        </a>
        <a href="https://tnreginet.gov.in/portal/webEServices/certifiedCopy" target="_blank" rel="nofollow noopener" class="portal-btn" title="Visit the official 📄
            Certified EC Portal website (External Link)">
            <span class="portal-btn-icon">📄</span>
            <span>Certified EC Portal</span>
        </a>
        <a href="https://tnreginet.gov.in/portal/userRegistration" target="_blank" rel="nofollow noopener" class="portal-btn" title="Visit the official 👤
            User Registration website (External Link)">
            <span class="portal-btn-icon">👤</span>
            <span>User Registration</span>
        </a>
        <a href="https://tnreginet.gov.in/portal/webEServices/ecStatus" target="_blank" rel="nofollow noopener" class="portal-btn" title="Visit the official ⌛
            Check EC Status website (External Link)">
            <span class="portal-btn-icon">⌛</span>
...
<div class="card">
    <h2 id="heading-1">Detailed Research Guide: online ec tamilnadu</h2>
    ...
    <p class="content-text">
        Using an <a href="/ec-online/" title="Read our comprehensive guide on ec online">ec online</a> verification platform helps buyers confirm that the seller actually has the legal right to transfer the property. Without a thorough review, you might purchase a property that has been secretly mortgaged, leading to long-standing legal disputes with financial institutions.
    </p>
</div>

<div class="card">
    <h2 id="heading-2">View EC vs. Certified Copy: What is the Difference?</h2>
    <p class="content-text">
...
<div class="card">
    <h2 id="heading-3">1. Free Method: How to View EC Online (Step-by-Step)</h2>
    <p class="content-text">
...
<div class="card">
    <h2 id="heading-4">2. Paid Method: Applying for a Certified Encumbrance Certificate</h2>
    <p class="content-text">
...
<div class="card">
    <h2 id="heading-5">Troubleshooting Font Display and Document Issues</h2>
    <p class="content-text">
...
<div class="card">
    <h2 id="heading-6">Connecting Land Records: View Patta Chitta and EC Online</h2>
    <p class="content-text">
