<?php
return array (
  'slug' => 'online-ec-telangana',
  'keyword' => 'online ec telangana, ts ec search online, igrs telangana ec search, dharani ec search, registration telangana gov in ec, hyderabad ec search',
  'title' => 'EC Online Telangana: IGRS TS Search (2026)',
  'meta_desc' => 'Complete guide on searching and downloading Online Encumbrance Certificate (EC) in Telangana via IGRS TS and Dharani portals. Learn SRO search steps and fee rules.',
  'h1_title' => 'EC Online Telangana: IGRS TS & Dharani Search Manual',
  'schema_type' => 'TechArticle',
  'faq_data' => '[{"question":"How can I search Telangana EC by property house number or survey number?","answer":"Log into registration.telangana.gov.in, select Encumbrance Search, choose Criteria Search, select SRO Office, Village, and enter House Number or Survey Number with sub-division."}]',
  'content' => '<div class="manual-page-container" style="line-height: 1.8; color: var(--text-main);">
    <p style="font-size: 1.08rem; margin-bottom: 25px;">
        Searching and downloading an <strong>Online Encumbrance Certificate (EC) in Telangana</strong> is a vital statutory step for property buyers, legal advisors, and home loan applicants across Hyderabad, Cyberabad, Warangal, Nizamabad, and all districts of Telangana. Governed by the Registration and Stamps Department (IGRS TS) and the <strong>Dharani Portal</strong>, an Encumbrance Certificate outlines the 30-year registered transaction history, mortgages, gift deeds, court attachments, and title transfers recorded at jurisdictional Sub-Registrar Offices (SROs).
    </p>
    ...
    <div class="quick-summary-box" style="background: rgba(241, 245, 249, 0.7); padding: 20px; border-radius: 8px; margin-bottom: 30px;">
        <h3 style="margin-top: 0; color: var(--primary);">Telangana EC Online Search Highlights</h3>
        <ul>
            <li><strong>Official Portals:</strong> <code>registration.telangana.gov.in</code> (Urban Municipal Properties) & <code>dharani.telangana.gov.in</code> (Agricultural Revenue Lands).</li>
            <li><strong>Search Modes:</strong> Document Number Search, Year of Registration, Layout Plot / Survey Number, and Property House Number Search.</li>
            <li><strong>Digitized Timeline:</strong> Complete digital EC coverage available from 1983 to Present Date across all SRO circles in Telangana.</li>
            <li><strong>Legal Validity:</strong> Digitally signed e-EC downloads carry legal validity under Section 65B of the Indian Evidence Act.</li>
        </ul>
    </div>

    <h2 id="section-1" style="color: var(--primary); font-size: 1.5rem; margin-top: 30px;">1. Step-by-Step Guide to Download EC Online in Telangana (IGRS TS)</h2>
    <ol class="step-list">
        <li>Visit the official IGRS Telangana portal at <code>registration.telangana.gov.in</code>.</li>
        <li>Click on <strong>Encumbrance Search (EC)</strong> under Online Services.</li>
        <li>Login using registered mobile number or create a free user account.</li>
        <li>Read the legal disclaimer policy and click <strong>Submit</strong>.</li>
        <li>Select search option: <em>Document No.</em> or <em>Form 15 Criteria Search (District, SRO, Village, House No / Survey No)</em>.</li>
        <li>Enter search period (e.g., 01/01/1983 to Current Date) and click <strong>Submit</strong>.</li>
        <li>View the Index II registered entries and click <strong>Download Certified EC PDF</strong>.</li>
    </ol>
    ...
    <div class="faq-container">
        <div class="faq-item">
            <h4 class="faq-question">Q1: How can I search Telangana EC by property house number or survey number?</h4>
            <p class="faq-answer">Log into registration.telangana.gov.in, select Encumbrance Search, choose Criteria Search, select SRO Office, Village, and enter House Number or Survey Number with sub-division.</p>
        </div>
        <div class="faq-item">
            <h4 class="faq-question">Q2: What is the fee for downloading EC online in Telangana?</h4>
            <p class="faq-answer">The online search fee is ₹25 for the initial search year and ₹5 for each additional search year, payable through the online portal payment gateway.</p>
        </div>
    </div>
</div>
