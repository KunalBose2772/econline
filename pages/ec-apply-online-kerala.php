...
return array (
  ...
  'faq_data' => '[{"question":"How do I apply for a certified EC online in Kerala?","answer":"Log into keralaregistration.gov.in, select \'Online Applications\' -> \'Encumbrance Certificate\', enter SRO details, survey number, and date range, pay the fee via e-Treasury, and download your signed EC PDF."}]',
  'content' => '
<div class="manual-page-container" style="line-height: 1.7; color: var(--text-main);">
    
    <p style="font-size: 1.05rem; margin-bottom: 25px;">Applying for a certified <strong>Encumbrance Certificate (Kudippika) online in Kerala</strong> is managed seamlessly through the <strong>PEARL Portal</strong> (`keralaregistration.gov.in`).</p>
...
<div class="db-legacy-content" style="margin-top: 30px;"><p class="content-text">
    Property transaction checks in Kerala have been simplified with the launch of the digital registration network. Through the official Pearl portal managed by the registration department, citizens can submit application details from home. Completing your search parameters using <strong><a href="/ec-online/" title="Read our comprehensive guide on ec online">ec online</a></strong> portals ensures clean property transfers and helps verify SRO transaction logs.
</p>
