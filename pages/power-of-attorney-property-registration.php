<?php
return array (
  'slug' => 'india/power-of-attorney-property-registration',
  'keyword' => 'power of attorney property registration, GPA vs SPA, registered power of attorney, NRI power of attorney adjudication, Suraj Lamp ruling POA',
  'title' => 'Power of Attorney Property Registration (2026)',
  'meta_desc' => 'Comprehensive legal guide on Power of Attorney (GPA/SPA) for property registration, SRO adjudication rules, NRI POA requirements, and Suraj Lamp Supreme Court ruling.',
  'h1_title' => 'Power of Attorney Property Registration: Legal Guide',
  'schema_type' => 'TechArticle',
  'faq_data' => '[{"question":"Can a property be bought legally through a General Power of Attorney (GPA)?","answer":"No. Following the Supreme Court ruling in Suraj Lamp & Industries vs. State of Haryana, a GPA transaction does not convey legal title or ownership. Legal title passes only via a registered Sale Deed executed at the SRO."}]',
  'content' => '<div class="manual-page-container" style="line-height: 1.8; color: var(--text-main);">
    <p style="font-size: 1.08rem; margin-bottom: 25px;">
        A <strong>Power of Attorney (POA)</strong> is a statutory legal instrument governed by the <strong>Powers of Attorney Act, 1882</strong>, the <strong>Indian Contract Act, 1872</strong>, and the <strong>Indian Registration Act, 1908</strong> that authorizes an agent (attorney holder) to act on behalf of the principal in legal, financial, and property matters. When executing real estate transactions—such as signing sale deeds, managing tenancy agreements, or submitting building plans—understanding the distinction between a <strong>General Power of Attorney (GPA)</strong>, <strong>Special Power of Attorney (SPA)</strong>, registered POA requirements, and Supreme Court rulings is vital for avoiding title invalidity.
    </p>
    ...
    <div class="quick-summary-box" style="background: rgba(241, 245, 249, 0.7); padding: 20px; border-radius: 8px; margin-bottom: 30px;">
        <h3 style="margin-top: 0; color: var(--primary);">Key Legal Takeaways: Power of Attorney in Real Estate</h3>
        <ul>
            <li><strong>GPA vs SPA:</strong> A General Power of Attorney grants wide-ranging administrative powers; a Special Power of Attorney authorizes a single specific transaction (e.g., executing one specific sale deed).</li>
            <li><strong>Mandatory Registration:</strong> Under Section 17 of the Registration Act, any Power of Attorney authorizing the sale, mortgage, or transfer of immovable property must be mandatorily registered at the SRO.</li>
            <li><strong>Supreme Court Landmark Ruling (Suraj Lamp):</strong> Supreme Court held that property transfers executed via GPA/SA/WILL do not convey legal title or ownership interest without a registered Sale Deed.</li>
            <li><strong>NRI Power of Attorney Adjudication:</strong> Foreign POA executed abroad must be notarized, authenticated by the Indian Embassy/Consulate, and adjudicated at the District Collector/Sub-Registrar office in India within 3 months.</li>
        </ul>
    </div>

    <h2 id="section-1" style="color: var(--primary); font-size: 1.5rem; margin-top: 30px;">1. Detailed Comparison: GPA vs SPA</h2>
        ...
        <table class="styled-table" style="width: 100%; border-collapse: collapse; margin: 20px 0;">
            <thead>
                <tr style="background: var(--surface); text-align: left;">
                    ...
                    <th style="padding: 12px; border: 1px solid var(--border);">General Power of Attorney (GPA)</th>
                    <th style="padding: 12px; border: 1px solid var(--border);">Special Power of Attorney (SPA)</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td style="padding: 10px; border: 1px solid var(--border);"><strong>Scope of Authority</strong></td>
                    <td style="padding: 10px; border: 1px solid var(--border);">Broad, multiple powers covering property management, tax filings, legal representation, and bank operations.</td>
                    <td style="padding: 10px; border: 1px solid var(--border);">Restricted strictly to one specific act (e.g., presenting a sale deed for registration at SRO).</td>
                </tr>
                <tr>
                    <td style="padding: 10px; border: 1px solid var(--border);"><strong>Termination</strong></td>
                    <td style="padding: 10px; border: 1px solid var(--border);">Remains active until revoked by principal, or upon death/insanity of principal or agent.</td>
                    <td style="padding: 10px; border: 1px solid var(--border);">Terminates automatically upon completion of the specified transaction.</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <h2 id="section-2" style="color: var(--primary); font-size: 1.5rem; margin-top: 30px;">2. Frequently Asked Questions (FAQ)</h2>
    <div class="faq-container">
        <div class="faq-item">
            <h4 class="faq-question">Q1: Can a property be bought legally through a General Power of Attorney (GPA)?</h4>
            <p class="faq-answer">No. Following the Supreme Court ruling in <em>Suraj Lamp & Industries vs. State of Haryana</em>, a GPA transaction does not convey legal title or ownership. Legal title passes only via a registered Sale Deed executed at the SRO.</p>
        </div>
        <div class="faq-item">
            <h4 class="faq-question">Q2: Does a Power of Attorney remain valid after the death of the principal?</h4>
            <p class="faq-answer">No. A Power of Attorney automatically terminates upon the death of the principal under Section 201 of the Indian Contract Act. Any transaction executed post-death by the attorney holder is legally void.</p>
        </div>
    </div>
</div>
<div class="comprehensive-seo-depth-block" style="margin-top: 35px; border-top: 2px solid var(--border); padding-top: 25px; line-height: 1.8;">
