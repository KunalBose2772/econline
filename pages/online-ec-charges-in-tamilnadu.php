<?php
return array (
  'slug' => 'online-ec-charges-in-tamilnadu',
  'keyword' => 'online ec charges in tamilnadu, tnreginet ec fees, villangam certificate cost tamil nadu, sro copy fee tnreginet',
  'title' => 'Online EC Charges in Tamil Nadu: SRO Fee Matrix (2026)',
  'meta_desc' => 'Check official government EC charges in Tamil Nadu via TNREGINET. Learn search fees, certified copy fees, and online payment methods.',
  'h1_title' => 'Online EC Charges in Tamil Nadu: Official SRO Fee Schedule',
  'schema_type' => 'TechArticle',
  'faq_data' => '[{"question":"What are the official government fees for searching an EC in Tamil Nadu?","answer":"Viewing an EC online on TNREGINET is free. Certified PDF copies cost Rs. 1 for the 1st year search + Rs. 5 for every additional year + Rs. 100 certificate fee + user charges."}]',
  'content' => '
<div class="manual-page-container" style="line-height: 1.7; color: var(--text-main);">
    
    <p style="font-size: 1.05rem; margin-bottom: 25px;">The Commercial Taxes and Registration Department of Tamil Nadu fixes nominal government fees for Encumbrance Certificate (Villangam) searches and certified copies requested through <strong>TNREGINET</strong> (`tnreginet.gov.in`).</p>
