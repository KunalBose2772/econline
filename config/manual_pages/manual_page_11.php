<?php
// config/manual_pages/manual_page_11.php
return [
    'slug' => 'guideline-value-tamilnadu',
    'keyword' => 'guideline value tamilnadu',
    'title' => 'Guideline Value Tamilnadu Online: Check TN Land Registry Rates',
    'meta_desc' => 'Check the official guideline value tamilnadu online. Find street rates, SRO database values, survey codes, and calculate stamp duty on TNREGINET.',
    'h1_title' => 'Guideline Value Tamilnadu: TNREGINET Land Registration Value Guide',
    'schema_type' => 'Article',
    'faq_data' => '[
        {"question": "How do I check guideline value tamilnadu online?", "answer": "Log in to the official TNREGINET portal, select the guideline value search, select the year range, and enter your district, taluk, village, and survey number."},
        {"question": "Is checking the guideline value tamilnadu free?", "answer": "Yes, viewing property guideline rates on the TNREGINET portal is free for all citizens."},
        {"question": "How often is the guideline value tamilnadu revised?", "answer": "The Tamil Nadu state government Valuation Committee revises guideline values periodically to align them with prevailing market conditions."},
        {"question": "What is the penalty for registering below the guideline value tamilnadu?", "answer": "Under Section 47A of the Stamp Act, registering below the guideline value leads to a suspension of the deed and referral to the collector to pay the deficit."}
    ]',
    'content' => '
<div class="manual-page-container">
    <h1>Guideline Value Tamilnadu: TNREGINET Land Registration Value Guide</h1>
    <p>Checking the official <strong>guideline value tamilnadu</strong> is an essential pre-registration step for property buyers in Tamil Nadu. The guideline value is the minimum estimated market rate of land in a specific street, survey number, or village as determined by the state government. Under the Indian Stamp Act, property registrations must pay stamp duty and registration fees calculated on the guideline value or the actual sale consideration, whichever is higher. Retrieving your document records through an <a href="/ec-online/">ec online</a> portal can help confirm that previous transactions were registered under correct valuation baselines. You can also perform a <a href="/tn-ec-view/">TN EC View</a> search or obtain a <a href="/villangam/">villangam certificate</a> online to verify historical deeds.</p>

    <h2>The Legal Basis of Guideline Values</h2>
    <p>Under the Stamp Act, the registration department is authorized to determine minimum values for property transactions to prevent tax evasion through undervalued sale deeds. In Tamil Nadu, the Valuation Committee revises the <strong>guideline value tamilnadu</strong> periodically based on location parameters. When a buyer registers a sale deed, SRO officers check the property schedule. If the declared value in the deed falls below the guideline rate, Section 47A of the Act allows the SRO to suspend the deed and refer the valuation to the Special Deputy Collector (Stamps) for market rate assessment. Conducting a parallel search via <a href="/land-ec/">land ec</a> helps confirm that all previous transactions complied with state valuation codes. Ensure you check your <a href="/patta-chitta-online-tamil-nadu/">patta chitta</a> status to confirm revenue records match the sub-registrar files.</p>
    ...
    <p>When searching the guideline portal, pay close attention to land classification. Agricultural lands are valued per hectare or acre, while residential layouts are valued per square foot or square meter. Entering residential land under an agricultural classification is a common error that leads to undervaluation warnings from the SRO. If the portal reports "Value not found", it indicates that the specific subdivision has not been updated in the digital registry, requiring a physical application at the SRO to obtain a certificate of value. Buyers can use an <a href="/ec-online/">ec online</a> check to inspect previous sales, which lists property descriptions and helps confirm correct land classifications.</p>

    <h2>Types of Property Deeds and Valuation Calculations</h2>
    <p>Valuation parameters apply differently depending on the specific deed class. In an outright sale deed, the valuation base is always the higher of the guideline value or the declared contract price. In family gift settlements or partition deeds, however, the stamp duty is typically calculated strictly on the guideline value as of the date of execution, subject to maximum state-prescribed caps. Release deeds executed between family co-owners also follow a subsidized stamp duty framework. Buyers must ensure that their deed classification is designated correctly in the draft documents, as an incorrect classification could result in rejection at the sub-registrar office. Checking historic transactions on similar properties helps buyers understand how the local SRO has classified and valued comparable transactions in the past.</p>

    <h2>The Section 47A Valuation Reference Process</h2>
    <p>If the Sub-Registrar Office determines that the property is undervalued, the registration transaction is flagged. The document is registered provisionally, but the physical deed is retained by the SRO. The case file is referred to the Special Deputy Collector (Stamps) under Section 47A of the Indian Stamp Act. The Collector conducts a field inspection of the property, queries local market indexes, and issues a notice to the buyer specifying the determined market value and the stamp duty deficit. The buyer has 21 days to appeal the valuation or pay the deficit. Once paid, the SRO releases the original registered sale deed. Checking records via the ec online lookup is highly advised, as court attachments or pending valuation disputes are recorded under the property\'s transaction log.</p>
    ...
    <div class="interactive-widgets-section" style="background-color: #f8fafc; padding: 25px; border-radius: 12px; border: 1px solid #e2e8f0; margin-top: 30px;">
        ...
        <div id="app-state-select" class="widget-container" style="margin-bottom: 20px;">
            ...
            <select id="state_selector_guideline_tn" onchange="updateStateInfo_guideline_tn()" style="width: 100%; padding: 10px; border-radius: 6px; border: 1px solid #cbd5e1; font-size: 1rem; outline: none; background: #ffffff;">
            ...
            <div id="state_info_box_guideline_tn" style="margin-top: 10px; padding: 12px; border-radius: 6px; background-color: #f1f5f9; display: none;"></div>
        </div>
        ...
        <div id="app-calc-years" class="widget-container" style="margin-bottom: 20px;">
            ...
            <input type="number" id="tenure_years_guideline_tn" min="1" max="50" value="15" oninput="calculateEstimates_guideline_tn()" style="width: 100%; padding: 10px; border-radius: 6px; border: 1px solid #cbd5e1; outline: none; box-sizing: border-box;" />
            <div id="calc_results_box_guideline_tn" style="margin-top: 10px; padding: 12px; border-radius: 6px; background-color: #f1f5f9; font-weight: 500;">
        ...
        <div id="app-readiness-deed" class="widget-container">
            ...
            <div style="display: grid; gap: 8px;">
                <label style="display: flex; align-items: center; gap: 8px;"><input type="checkbox" class="chk_guideline_tn" onclick="updateChecklist_guideline_tn()"> Survey / Subdivision Number</label>
                <label style="display: flex; align-items: center; gap: 8px;"><input type="checkbox" class="chk_guideline_tn" onclick="updateChecklist_guideline_tn()"> Sub-Registrar Office (SRO) Name</label>
                <label style="display: flex; align-items: center; gap: 8px;"><input type="checkbox" class="chk_guideline_tn" onclick="updateChecklist_guideline_tn()"> Previous Sale Deed Document Number</label>
            </div>
            <div style="margin-top: 12px; height: 8px; background-color: #e2e8f0; border-radius: 4px; overflow: hidden;">
                <div id="progress_bar_guideline_tn" style="width: 0%; height: 100%; background-color: #10b981; transition: width 0.3s ease;"></div>
            </div>
            <div id="checklist_status_guideline_tn" style="margin-top: 8px; font-size: 0.9rem; font-weight: 500;">Readiness: 0%</div>
        </div>
    </div>

    <script>
    function updateStateInfo_guideline_tn() {
        var selector = document.getElementById("state_selector_guideline_tn");
        var infoBox = document.getElementById("state_info_box_guideline_tn");
    ...
    <script>
    function calculateEstimates_guideline_tn() {
        var years = parseInt(document.getElementById("tenure_years_guideline_tn").value) || 0;
        var cost = 10 + (years * 5);
        document.getElementById("calc_results_box_guideline_tn").innerText = "Estimated search fee: Rs. " + cost.toFixed(2);
    }
    </script>
    <script>
    function updateChecklist_guideline_tn() {
        var chks = document.getElementsByClassName("chk_guideline_tn");
        var checkedCount = 0;
        for (var i = 0; i < chks.length; i++) {
            if (chks[i].checked) checkedCount++;
        }
        var percent = Math.round((checkedCount / chks.length) * 100);
        document.getElementById("progress_bar_guideline_tn").style.width = percent + "%";
        document.getElementById("checklist_status_guideline_tn").innerText = "Readiness: " + percent + "%";
    }
    </script>
</div>
'
